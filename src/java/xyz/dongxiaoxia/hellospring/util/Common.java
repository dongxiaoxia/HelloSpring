...
import xyz.dongxiaoxia.hellospring.controller.ServerInfoController;
...
public class Common {
     ...
     *
     * @param date
     * @param patern 如“yyyy-MM-dd hh:mm:ss”
     * @return
     */
    public static String fromDate(Date date, String patern) {
